...
public class ContentApiController {
    ...
    @GetMapping
    public ResponseEntity<PageInfo<Content>> list(@RequestParam(value = "offset", defaultValue = "0") Integer offset) {
        PageInfo<Content> page = contentService.getContentsNotFeatureData(offset, 4);
