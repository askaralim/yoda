...
public class ContentController {
    ...
    @GetMapping
    public String showPanel(Map<String, Object> model, @RequestParam(name = "offset", defaultValue = "0") Integer offset) {
        PageInfo<Content> page = contentService.getContents(offset * 10, 10);
