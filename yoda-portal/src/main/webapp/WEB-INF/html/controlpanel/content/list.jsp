...
<%@ page import="com.taklip.yoda.util.DropDownMenuGenerator" %>
			...
			<div class="table-responsive">
				<table class="table table-striped">
					<c:if test="${page.data != null}">
						...
						<tbody>
							<c:forEach var="content" items="${page.data}">
								<tr>
									<td>
							...
							<ul class="pagination">
								<c:choose>
									<c:when test="${page.hasPreviousPage}">
										<li><a href='<spring:url value="/controlpanel/content?offset=${page.currentPageNo - 2}" />' aria-label="Previous"><span>&laquo;</span></a></li>
									</c:when>
									<c:otherwise>
