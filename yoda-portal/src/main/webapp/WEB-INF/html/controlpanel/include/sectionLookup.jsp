...
function jc_section_search_addnode(tree, jsonObject) {
	var url = "javascript:jc_section_search_callback_single(\"" + jsonObject.sectionId + "\", \"" + jsonObject.sectionShortTitle + "\")";
	var nodeText = { label: jsonObject.sectionShortTitle, href:url }; 
