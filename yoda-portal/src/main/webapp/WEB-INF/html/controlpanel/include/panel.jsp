	...
	<div>
		<div id="jc_panel_message">
			...
			<div class="bd">
				...
				&nbsp;
				<div>
					<a href="javascript:void(0);" onclick="jc_panel_message_finish()"
						class="jc_navigation_link">OK</a>&nbsp;
				</div>
			</div>
		</div>
	</div>
...
<script type="text/javascript">
	...
	YAHOO.util.Event.onDOMReady(jc_panel_error_init);
	...
	<div>
		<div id="jc_panel_error">
			...
			<div class="bd">
				...
				&nbsp;
				<div>
					<a href="javascript:void(0);" onclick="jc_panel_error_finish()"
						class="jc_navigation_link">OK</a>&nbsp;
				</div>
			</div>
		</div>
