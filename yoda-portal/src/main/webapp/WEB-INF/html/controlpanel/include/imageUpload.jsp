<script type="text/javascript">
	...
	function jc_image_upload_message(message) {
		var message = document.getElementById("jc_image_upload_message");
		message.innerHTML = message;
	}
	YAHOO.util.Event.onDOMReady(jc_image_upload_init);

	function jc_image_upload_callback() {
		var file = document.jc_image_upload_form.file.value;
		var result = '{"formName": "jc_image_upload_form","file": "'+ file +'"}';
			...
			<div id="jc_image_upload_panel">
				...
				<div class="bd">
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						...
						<tr>
							<td>
								<input type="file" name="file" class="jc_input_object" width="300px"></td>
						</tr>
						<tr>
						...
						<tr>
							<td>
								<a href="javascript:void(0);" onclick="jc_image_upload_callback();" class="jc_navigation_link">
									Confirm
								</a>
								<a href="javascript:void(0);" onclick="jc_image_upload_panel.hide()" class="jc_navigation_link">
									Cancel
								</a>&nbsp;
							</td>
						</tr>
