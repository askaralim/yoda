...
<%@ include file="../menu/panel.jsp"%>

<%@ page language="java" import="com.taklip.yoda.controlpanel.util.DropDownMenuGenerator"%>
<%@ page language="java" import="com.taklip.yoda.controlpanel.model.DropDownMenu"%>

<jsp:useBean id="menuEditCommand" type="com.taklip.yoda.controlpanel.model.MenuEditCommand" scope="request" />
