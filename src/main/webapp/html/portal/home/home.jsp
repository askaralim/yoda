		...
		<div class="home-main">
			...
			<div class="col-sm-12">
				<div class="home-brand">
					<h1 style="text-align: center"><spring:message code="top-viewed-brands" /></h1>
					<div class="row">
			...
			<div class="col-sm-12">
				<div class="home-item">
					<h1 style="text-align: center"><spring:message code="top-viewed-items" /></h1>
					<div class="row">
...
<script type="text/javascript" src='<spring:url value="/template/basic/jquery-1.11.1.min.js" />'></script>
