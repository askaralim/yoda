					...
					<div class="nav-tabs-custom">
						...
						<div class="tab-content">
							...
							<div class="tab-pane" id="tab-profile">
								...
								<div class="form-group">
									<label for="stateCode"><spring:message code="state" /></label>
									<form:select path="stateCode" cssClass="form-control">
										<form:options items="${homePageCommand.states}" itemLabel="stateName" itemValue="stateCode" />
									</form:select>
								</div>
