...
public interface MenuService extends IService<Menu> {
        ...
        void addMenu(long siteId, long menuId, String menuTitle, String menuName,
                        String menuUrl, String menuWindowTarget, String menuWindowMode,
                        boolean published, String menuType, long contentId, long itemId, long sectionId)
        ...
        Menu addMenu(long siteId, long menuParentId, long seqNum,
        ...
        Menu updateMenu(long lastVisitSiteId, long i, Content content, Item item,
