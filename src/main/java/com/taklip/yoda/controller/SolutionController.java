...
public class SolutionController {
    ...
    @GetMapping
    public String showSolutions(Map<String, Object> model, @RequestParam(defaultValue = "0") Integer offset) {
        Page<Solution> page = solutionService.getSolutions(offset, 10);
    ...
    public ModelAndView save(
            Solution solution, BindingResult result, RedirectAttributes redirect) {
    ...
    public ModelAndView initCreationForm(
            @PathVariable Long solutionId, Map<String, Object> model) {
    ...
    public String initSolutionItemUpdateForm(@PathVariable Long id, Map<String, Object> model) {
    ...
    public ModelAndView processCreationForm(
        ...
        return new ModelAndView("redirect:/controlpanel/solution/solutionItem/" + solutionItem.getId() + "/edit",
                model);
    }
