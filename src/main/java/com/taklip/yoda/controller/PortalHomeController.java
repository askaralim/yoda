...
public class PortalHomeController extends PortalBaseController {
    ...
    public HomeInfo getHome() {
        ...
        Page<ContentDTO> contents = contentService.getContentsByFeatureData(true, 0, 10);

        for (ContentDTO content : contents.getRecords()) {
        ...
        Page<ContentDTO> page = contentService.getContentsByFeatureData(false, 0, 4);
